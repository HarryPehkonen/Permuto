...
namespace permuto {
PlaceholderParser::PlaceholderParser(const std::string& start_marker, const std::string& end_marker)
...
PlaceholderParser::extract_exact_placeholder(const std::string& text) const {
...
std::string PlaceholderParser::replace_placeholders(
