...
private:
    ...
    nlohmann::json process_value(const nlohmann::json& value, const nlohmann::json& context) const;

    nlohmann::json process_string(const std::string& str, const nlohmann::json& context) const;

    nlohmann::json process_object(const nlohmann::json& obj, const nlohmann::json& context) const;

    nlohmann::json process_array(const nlohmann::json& arr, const nlohmann::json& context) const;
