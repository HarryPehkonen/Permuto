...
int main() {
    ...
    try {
        ...
        try {
            ...
            std::cout << "This should not be reached - missing /coordinates/z should cause error"
                      << std::endl;
    ...
    std::cout << "\n=== Summary ===" << std::endl;
    std::cout << "- ${} markers with Remove mode: Optional fields get removed if missing"
              << std::endl;
    std::cout << "- <<>> markers with Error mode: Required fields throw exception if missing"
              << std::endl;
    std::cout << "- Different marker types allow fine-grained control over behavior" << std::endl;
    std::cout << "- Process order matters: Remove mode first, then Error mode validation"
              << std::endl;
